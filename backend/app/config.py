...
HTTP_MAX_CONNECTIONS: int = int(os.getenv("HTTP_MAX_CONNECTIONS", "1200"))
HTTP_MAX_KEEPALIVE: int = int(os.getenv("HTTP_MAX_KEEPALIVE", "200"))
...
GENERATION_WORKER_CONCURRENCY: int = int(os.getenv("GENERATION_WORKER_CONCURRENCY", "100"))
